...
- `key`: The value of the key pressed (e.g., "a", "Enter", "ArrowUp"). <!-- element class="fragment" -->
- `code`: The physical key on the keyboard (e.g., "KeyA", "Enter", "ArrowUp"). <!-- element class="fragment" -->
- `altKey`, `ctrlKey`, `shiftKey`, `metaKey`: Boolean flags indicating if modifier keys were pressed. <!-- element class="fragment" -->
