...
WTWR ("What to Wear?") is a web application that suggests clothing based on the weather in your location.

<!-- element class="fragment" -->

In this stage we'll be integrating the currenct Project with Json-server
...
To simulate a backend server, we will use `json-server`.
...
Now you can make requests to `http://localhost:3001/items`.
