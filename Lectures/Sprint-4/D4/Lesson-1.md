...
# Intermediate Bash + Project Spots Interactive Modals

---

## Working quickly with the command line
...
## Getting help without leaving the command line

- `man`: Display the manual page for a command.
- `tldr`: A simplified and community-driven man page.
...
## Project: Spots Interactive Modals
